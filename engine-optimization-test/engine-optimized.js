(() => {
  const canvas = document.getElementById("engine-opt-canvas");
  ...
  const modes = {
    optimized: { fps: 30, dprCap: 1.5, particleCap: 110 },
    quality: { fps: 60, dprCap: 2, particleCap: 130 },
  ...
  function drawStaticBackdrop() {
    ...
    staticCtx.strokeStyle = "rgba(255,255,255,0.04)";
  ...
  function addParticle(x, y, vx, vy, life, radius, color, maxY = null) {
    const mode = currentMode();
    if (state.particles.length > mode.particleCap) return;
  ...
  function releaseParticle(index) {
    ...
    state.particles.pop();
    if (pool.length < 180) pool.push(particle);
  }
  ...
  function drawBackdrop(cycle) {
    ...
    glow.addColorStop(0, `${cycle.color}24`);
    glow.addColorStop(0.42, "rgba(255,255,255,0.035)");
  ...
  function drawEngine() {
    ...
    ctx.strokeStyle = "rgba(235,241,250,0.28)";
    ...
    chamberGradient.addColorStop(0, `${cycle.color}5f`);
    chamberGradient.addColorStop(1, `${cycle.color}07`);
    ...
    pistonGradient.addColorStop(0, "rgba(248,250,255,0.8)");
    pistonGradient.addColorStop(1, "rgba(122,132,146,0.74)");
    ...
    ctx.strokeStyle = cycle.index === 2 ? "rgba(255,122,47,0.7)" : "rgba(255,255,255,0.52)";
  ...
  function drawValve(x, y, direction, lift, scale) {
    ...
    ctx.strokeStyle = "rgba(225,232,242,0.38)";
    ctx.lineWidth = 5 * scale;
    ctx.beginPath();
    ctx.moveTo(0, -38 * scale);
    ctx.lineTo(0, 28 * scale);
    ctx.stroke();
    ctx.fillStyle = "rgba(225,232,242,0.48)";
    ctx.beginPath();
  ...
  glowInput.addEventListener("change", () => drawStaticBackdrop());
